...
function App() {
  ...
  const [permitForm, setPermitForm] = useState<PermitFormState>({
    permit_id: '',
      ...
      <header className="hero-card">
        <div>
          ...
          <p className="mini-note">
            ...
            longitudinal visit capture, SHA-256 artifact hashing, simulated ledger blocks, and
        ...
        <div className="section-header">
          <div>
            ...
            <p className="section-copy">
              Secondary-use dashboard access is controlled by a simulated EHDS-style data access permit.
            </p>
          </div>
        </div>
          ...
          <div className="panel">
            <div className="section-header compact">
              <div>
                ...
                <p className="section-copy">
                  All downstream analytics, patient data, ledger detail, and dashboard views operate under the active permit.
                </p>
              </div>
            </div>
      ...
      <section className="section">
        <div className="section-header">
          <div>
            ...
            <p className="section-copy">
              Simulate a site dataset drop. The backend stores the metadata, hashes the payload, and
              appends a simulated ledger block.
            </p>
          </div>
        </div>
        ...
        <form className="panel" onSubmit={handleDatasetSubmit}>
          <div className="form-grid">
            <label className="field">
              <span>Site name</span>
              <input name="site_name" value={datasetForm.site_name} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Source type</span>
              <select name="source_type" value={datasetForm.source_type} onChange={handleDatasetChange}>
            ...
            <label className="field">
              <span>Country</span>
              <input name="country" value={datasetForm.country} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Operator ID</span>
              <input name="operator_id" value={datasetForm.operator_id} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Record count</span>
              <input type="number" min="0" name="record_count" value={datasetForm.record_count} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>HBV cohort represented</span>
              <input type="number" min="0" name="hbv_cohort" value={datasetForm.hbv_cohort} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Bepirovirsen-treated</span>
              <input type="number" min="0" name="bepirovirsen_treated" value={datasetForm.bepirovirsen_treated} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Data quality score</span>
              <input type="number" min="0" max="100" step="0.1" name="dq_score" value={datasetForm.dq_score} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Readiness score</span>
              <input type="number" min="0" max="100" step="0.1" name="readiness_score" value={datasetForm.readiness_score} onChange={handleDatasetChange} required />
            </label>

            <label className="field">
              <span>Temporal issue count</span>
              <input type="number" min="0" name="temporal_issue_count" value={datasetForm.temporal_issue_count} onChange={handleDatasetChange} required />
            </label>

            <label className="field field-checkbox">
              <span>Schema manifest signed</span>
              <input type="checkbox" name="schema_signed" checked={datasetForm.schema_signed} onChange={handleDatasetChange} />
            </label>

            <label className="field field-checkbox">
              <span>Needs OMOP vocabulary remap</span>
              <input type="checkbox" name="needs_vocab_remap" checked={datasetForm.needs_vocab_remap} onChange={handleDatasetChange} />
            </label>

            <label className="field field-full">
              <span>Notes</span>
              <textarea name="notes" value={datasetForm.notes} onChange={handleDatasetChange} rows={3} />
            </label>
      ...
      <section className="section">
        <div className="section-header">
          <div>
            ...
            <p className="section-copy">
              The patient workflow is now organized into screening, baseline, treatment, on-treatment,
              and post-treatment sections to feel closer to a real clinical capture flow.
            </p>
          </div>
        </div>
        ...
        <div className="panel clinical-panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">
                Create a pseudonymised baseline patient record with screening history, baseline virology,
                liver markers, and treatment status.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handlePatientSubmit}>
            ...
            >
              <label className="field">
                <span>Site name</span>
                <input name="site_name" value={patientForm.site_name} onChange={handlePatientChange} required />
              </label>

              <label className="field">
                <span>Country</span>
                <input name="country" value={patientForm.country} onChange={handlePatientChange} required />
              </label>

              <label className="field">
                <span>Operator ID</span>
                <input name="operator_id" value={patientForm.operator_id} onChange={handlePatientChange} required />
              </label>

              <label className="field">
                <span>Patient pseudonym</span>
                <input name="patient_pseudonym" value={patientForm.patient_pseudonym} onChange={handlePatientChange} required />
              </label>
              ...
              <label className="field">
                ...
                <input type="number" name="year_of_birth" value={patientForm.year_of_birth} onChange={handlePatientChange} required />
              </label>

              <label className="field">
                <span>Diagnosis date</span>
                <input type="date" name="diagnosis_date" value={patientForm.diagnosis_date} onChange={handlePatientChange} required />
              </label>

              <label className="field">
                <span>HBeAg status at baseline</span>
                <select name="hbeag_status" value={patientForm.hbeag_status} onChange={handlePatientChange}>
                  <option value="unknown">Unknown</option>
              ...
              <label className="field field-checkbox">
                ...
                <input type="checkbox" name="chronic_hbv_confirmed" checked={patientForm.chronic_hbv_confirmed} onChange={handlePatientChange} />
              </label>
            </FormSection>
            ...
            >
              <label className="field">
                ...
                <input name="baseline_hbsag" value={patientForm.baseline_hbsag} onChange={handlePatientChange} placeholder="e.g. 3.4" />
              </label>

              <label className="field">
                <span>Baseline HBV DNA</span>
                <input name="baseline_hbv_dna" value={patientForm.baseline_hbv_dna} onChange={handlePatientChange} placeholder="e.g. 1250" />
              </label>

              <label className="field">
                <span>Baseline ALT</span>
                <input name="baseline_alt" value={patientForm.baseline_alt} onChange={handlePatientChange} placeholder="e.g. 42" />
              </label>

              <label className="field">
                <span>Baseline AST</span>
                <input name="baseline_ast" value={patientForm.baseline_ast} onChange={handlePatientChange} placeholder="e.g. 38" />
              </label>

              <label className="field">
                <span>Bilirubin</span>
                <input name="bilirubin" value={patientForm.bilirubin} onChange={handlePatientChange} />
              </label>

              <label className="field">
                <span>Albumin</span>
                <input name="albumin" value={patientForm.albumin} onChange={handlePatientChange} />
              </label>
            ...
            >
              <label className="field field-checkbox">
                ...
                <input type="checkbox" name="on_na_therapy" checked={patientForm.on_na_therapy} onChange={handlePatientChange} />
              </label>

              <label className="field field-checkbox">
                <span>Bepirovirsen eligible</span>
                <input type="checkbox" name="bepirovirsen_eligible" checked={patientForm.bepirovirsen_eligible} onChange={handlePatientChange} />
              </label>

              <label className="field field-checkbox">
                <span>Started bepirovirsen</span>
                <input type="checkbox" name="started_bepirovirsen" checked={patientForm.started_bepirovirsen} onChange={handlePatientChange} />
              </label>

              <label className="field field-full">
                <span>Clinical notes</span>
                <textarea name="notes" value={patientForm.notes} onChange={handlePatientChange} rows={3} placeholder="Eligibility rationale, family history, symptoms, alcohol use, comorbidities, or other clinical context." />
              </label>
            </FormSection>
        ...
        <div className="panel clinical-panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">
                Record on-treatment or post-treatment monitoring visits with serial HBV markers and outcome state.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleVisitSubmit}>
            ...
            >
              <label className="field field-full">
                <span>Patient</span>
                <select name="patient_id" value={visitForm.patient_id} onChange={handleVisitChange} required>
              ...
              <label className="field">
                ...
                <input type="date" name="visit_date" value={visitForm.visit_date} onChange={handleVisitChange} required />
              </label>

              <label className="field">
                <span>Visit stage</span>
                <select name="visit_type" value={visitForm.visit_type} onChange={handleVisitChange}>
            ...
            >
              <label className="field">
                ...
                <input name="quantitative_hbsag" value={visitForm.quantitative_hbsag} onChange={handleVisitChange} />
              </label>
              ...
              <label className="field">
                ...
                <select name="hbeag_status" value={visitForm.hbeag_status} onChange={handleVisitChange}>
                  <option value="unknown">Unknown</option>
                  <option value="positive">Positive</option>
                  <option value="negative">Negative</option>
                </select>
              ...
              <label className="field field-checkbox">
                ...
                <input type="checkbox" name="hbv_dna_detectable" checked={visitForm.hbv_dna_detectable} onChange={handleVisitChange} />
              </label>
            </FormSection>
            ...
            >
              <label className="field">
                <span>Bilirubin</span>
                <input name="bilirubin" value={visitForm.bilirubin} onChange={handleVisitChange} />
              </label>

              <label className="field">
                <span>Albumin</span>
                <input name="albumin" value={visitForm.albumin} onChange={handleVisitChange} />
              </label>
            ...
            >
              <label className="field field-checkbox">
                <span>On NA therapy</span>
                <input type="checkbox" name="on_na_therapy" checked={visitForm.on_na_therapy} onChange={handleVisitChange} />
              </label>

              <label className="field field-checkbox">
                <span>On bepirovirsen</span>
                <input type="checkbox" name="on_bepirovirsen" checked={visitForm.on_bepirovirsen} onChange={handleVisitChange} />
              </label>

              <label className="field field-checkbox">
                <span>Functional cure endpoint</span>
                <input type="checkbox" name="functional_cure_endpoint" checked={visitForm.functional_cure_endpoint} onChange={handleVisitChange} />
              </label>

              <label className="field field-full">
                <span>Visit notes</span>
                <textarea name="notes" value={visitForm.notes} onChange={handleVisitChange} rows={3} placeholder="Clinical interpretation, flare comments, adherence notes, or follow-up plan." />
              </label>
            </FormSection>
      ...
      <section className="section">
        <div className="section-header">
          <div>
            ...
            <p className="section-copy">
              The prototype now demonstrates both dataset intake and structured HBV patient pathway capture.
            </p>
          </div>
        </div>
        ...
        <div className="lifecycle-grid">
          {data.data_lifecycle.map((stage, index) => (
            <article key={stage.step} className={`lifecycle-card ${stage.status}`}>
              ...
              {index < data.data_lifecycle.length - 1 ? <div className="stage-arrow">→</div> : null}
            </article>
          ))}
        </div>
      </section>
        ...
        <div className="panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">
                Every dataset, patient, and visit creates a new append-only record with block number, signer, timestamp, and artifact hash.
              </p>
            </div>
          </div>
        ...
        <div className="panel stack-panel">
          <div className="section-header compact">
            <div>
              <h2>Open findings</h2>
              <p className="section-copy">
                These findings now include patient-level missing HBV variables and temporal issues.
              </p>
            </div>
          </div>
      ...
      <section className="section">
        <div className="section-header">
          <div>
            ...
            <p className="section-copy">Structured baseline patient records stored in the prototype.</p>
          </div>
        </div>
        <div className="panel">
          <div className="ledger-table-wrap">
              ...
              <tbody>
                {patients.map((patient) => (
                  <tr key={patient.id}>
                    ...
                    <td>{patient.started_bepirovirsen ? 'Started' : patient.bepirovirsen_eligible ? 'Eligible' : 'No'}</td>
        ...
        <div className="panel chart-panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">Live dimensions derived from the current artifact store.</p>
            </div>
          </div>
        ...
        <div className="panel chart-panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">Issues are recalculated when datasets, patients, or visits change.</p>
            </div>
          </div>
          <div className="chart-wrap">
            <ResponsiveContainer width="100%" height={280}>
        ...
        <div className="panel chart-panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">Counts are aggregated directly from datasets and clinician-entry artifacts.</p>
            </div>
          </div>
          <div className="chart-wrap">
            <ResponsiveContainer width="100%" height={280}>
        ...
        <div className="panel">
          <div className="section-header compact">
            <div>
              ...
              <p className="section-copy">Computed from the current data in the prototype store.</p>
            </div>
          </div>
            ...
            {data.trial_readiness.map((item) => (
              <article key={item.criterion} className="readiness-card">
                <div className="readiness-topline">
                  ...
                  <span className={`status-chip ${item.status === 'Pass' ? 'verified' : 'monitor'}`}>
                    {item.status}
                  </span>
                </div>
                <p>{item.detail}</p>
